...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    <img class="mx-auto h-10 w-auto" src="https://raw.githubusercontent.com/MaruanBO/MaruanBO/master/assets/php.gif" alt="Your Company">
    ...
    <form class="space-y-6" action="index.php" method="POST">
      ...
      <div>
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">Prenom oublié?</a>
          </div>
        </div>
        <div class="mt-2">
