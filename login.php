...
<body>
  ...
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    <img class="mx-auto h-10 w-auto" src="hhttps://raw.githubusercontent.com/MaruanBO/MaruanBO/master/assets/php.gif" alt="Your Company">
  ...
  if(isset($_SESSION["errorMessage"])){
    echo "<p class ='text-red-400 text-center my-4' >".$_SESSION["errorMessage"]."</p>";
  };
  ?>
</div>
</body>
